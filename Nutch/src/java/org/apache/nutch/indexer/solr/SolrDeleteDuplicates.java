...
LOG.info("SolrDeleteDuplicates: currentDoc: "+currentDoc);


LOG.info("SolrDeleteDuplicates:NumDocs: "+numDocs);
...
//LOG.info("SolrDeleteDuplicates: Digest_DOC: "+doc.toString());

    // String digest = (String)doc.getFieldValue(SolrConstants.DIGEST_FIELD).toString();

//LOG.info("SolrDeleteDuplicates: Digest: "+digest);
...
//if(SolrConstants.CONTENT_FIELD.equals(null)||SolrConstants.CONTENT_FIELD==null||SolrConstants.CONTENT_FIELD.equals(""))
//{
//System.exit(0);
//}
...
digest = (String)doc.getFieldValue(SolrConstants.CONTENT_FIELD).toString();
...
System.exit(0);
  ...
  public static class SolrInputFormat extends InputFormat<Text, SolrRecord> {
    ...
    public RecordReader<Text, SolrRecord> createRecordReader(InputSplit split,
      ...
      solrQuery.setFields(SolrConstants.ID_FIELD, SolrConstants.BOOST_FIELD,
          SolrConstants.TIMESTAMP_FIELD, SolrConstants.CONTENT_FIELD);
  ...
  public int run(String[] args) throws IOException, InterruptedException,
    ...
    if (result) {
      LOG.info("SolrDeleteDuplicates: done."+result);
      return 0;
    }
