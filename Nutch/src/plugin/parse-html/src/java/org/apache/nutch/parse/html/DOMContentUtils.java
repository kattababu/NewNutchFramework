...
public class DOMContentUtils {
 ...
 private boolean ignorealternate;//add line
  ...
  public void setConf(Configuration conf) {
	...
	this.ignoreNoFollow = conf.getBoolean("parser.html.outlinks.ignore_nofollow", false);//  add line
        this.ignorealternate = conf.getBoolean("parser.html.outlinks.ignore_alternate", false);//  add line
  }
      ...
      if (nodeType == Node.ELEMENT_NODE) {
        ...
        if (params != null) {
          if (!shouldThrowAwayLink(currentNode, children, childLen, params)) {
            ...
            if (target != null && (!noFollow || ignoreNoFollow || ignorealternate) && !post)// modified Line
              try {
