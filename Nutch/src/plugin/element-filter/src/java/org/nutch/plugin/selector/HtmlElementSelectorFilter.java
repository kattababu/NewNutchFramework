package org.nutch.plugin.selector;
...
public static final Logger LOG = LoggerFactory
      .getLogger("org.nutch.plugin.selector.htmlelementselectorfilter");
...
//System.out.println("blacklist"+node);

        for(Selector blackListSelector : blackListSelectors) {
            if(blackListSelector.matches(node)) {
LOG.info("Stripping navigation BlackList..."+blackListSelector);
...
LOG.warn("Configured using [parser.html.selector.blacklist] to ignore all tags [" + elementsToExclude + "]...");
...
//System.out.println(elementsToInclude);
...
//System.out.println("welcome"+discriminator);
LOG.info("Stripping navigation Discriminator..."+discriminator);
...
LOG.info("Stripping navigation DiscriminatorString..."+discriminatorString);

//System.out.println("discrminate"+discriminatorString);
...
//System.out.println("type"+type);
 ...
 LOG.trace("Stripping.Type...... " +node.getNodeName());// + "#" + idNode.getNodeValue());
...
//System.out.println("classNode"+classNode);
 ...
 LOG.trace("Stripping Class.... " +classNode.getNodeValue());
                }
            }
...
//System.out.println("idNode"+idNode.getNodeValue());
